    ...
    <>
      <div className="Weather w-[340px] rounded-md shadow-xl bg-slate-600 text-white p-8 ">
        ...
        <div className="BottomCard text-center relative m-[15px] flex flex-col gap-3">
          ...
          <p className="font-medium">H:{data.main.temp_max}°C | L:{data.main.temp_min}°C</p>
        </div>
      </div>
      <div className="DetailBox flex flex-col justify-evenly w-[340px] h-[400px] rounded-md shadow-xl bg-slate-600 text-white p-6 ">
        ...
        <div className="h-[276px] grid grid-cols-2 grid-rows-2 gap-4">
          <div className="bg-slate-400 rounded-md flex flex-col p-5 relative">
            ...
            <img src="/public/icons/thermometer.svg" alt="thermometericon" className="absolute max-w-[50px] left-[85px] top-[10px]" />
          </div>
          <div className="bg-slate-400 rounded-md flex flex-col p-5 relative">
            ...
            <img src="/public/icons/barometer.svg" alt="barometericon" className="absolute max-w-[50px] left-[85px] top-[10px]" />
          </div>
          <div className="bg-slate-400 rounded-md flex flex-col p-5 relative">
            ...
            <img src="/public/icons/wind.svg" alt="windicon" className="absolute max-w-[50px] left-[85px] top-[10px]" />
          </div>
          <div className="bg-slate-400 rounded-md flex flex-col p-5 relative">
            ...
            <img src="/public/icons/humidity.svg" alt="humidityicon" className="absolute max-w-[55px] left-[85px] top-[6px]" />
          </div>
        </div>
      </div>
    </>
